...
SEED = 0
BATCH_SIZE = 64 #16#64 #Default 4
EVAL_BATCH_SIZE = 32 #8#32 #Default 16
MAX_LENGTH = 512
...
WANDB_ENABLED = True
WANDB_ENTITY = None
WANDB_PROJECT = "2d-pure-dpo_FSDP"

DEBUG = False
RUN_DIR = '/nfs/ritik.ritik/Nosiy_2D-DPO/2ddpo_pure_checkpoints_FSDP'
...
def worker_main(rank: int, world_size: int, policy: nn.Module, reference_model: Optional[nn.Module] = None):
    ...
    init_distributed(rank, world_size, port=FSDP_PORT)
